...
SETTINGS = [
    ...
    (
        ...
        [
            ...
            (
                "TIWA_TTS_EN",
                "English voice",
                "edge-tts voice for English replies. Others: en-US-JennyNeural, en-GB-SoniaNeural.",
                "en-US-AvaNeural",
                None,
            ),
        ],
    ...
    (
        ...
        [
            ...
            (
                "TIWA_WAKE_THRESHOLD",
                "Activation sensitivity threshold",
