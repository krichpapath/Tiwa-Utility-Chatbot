...
hit = dict(
    ...
    summary="QA",
    etag="revision1",
    start={"dateTime": "2026-09-10T18:00:00+07:00"},
    end={"dateTime": "2026-09-10T18:15:00+07:00"},
)
...
for bad in [
    dict(plan, new_title=""),
    dict(plan, new_start="yesterday"),
    dict(plan, new_start="2026-09-10T19:00", new_end="2026-09-10T18:00"),
]:
    with patch.object(gcal, "_service") as service:
