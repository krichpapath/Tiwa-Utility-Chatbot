...
with tempfile.TemporaryDirectory() as d:
    r.ROOT = Path(d)
    audio = (16000, (np.sin(np.arange(16000)*.1)*10000).astype(np.int16))
...
print('PASS recording creation, playback file, metadata editing, deletion, malformed data and path guards')
